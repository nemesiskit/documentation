...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'card-pizza', name: 'nc-cardpizza', component: () => import('./views/nemesischart/CardPizzaView.vue') },
      ...
      { path: 'chart-base', name: 'nc-chartbase', component: () => import('./views/nemesischart/ChartBaseView.vue') },
